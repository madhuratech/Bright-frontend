  ...
  return (
    <section className="bg-[#EEF2F7] py-10 sm:py-14 lg:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1400px] mx-auto bg-[#F8F8F8] rounded-[28px] sm:rounded-[36px] px-5 sm:px-8 lg:px-16 py-8 sm:py-12 lg:py-16">
        ...
        {/* Badge */}
        <FadeInSection>
          <div className="inline-flex items-center px-5 py-2 rounded-full bg-[#DDE6F2] text-[#1A4FA3] text-xs sm:text-sm font-medium tracking-wide">
            INDUSTRIES WE SERVE
          </div>
        </FadeInSection>
        ...
        <FadeInSection delay={0.1}>
          <div className="mt-6 max-w-4xl">
            ...
            <p className="mt-5 text-[#4A4A4A] text-sm sm:text-base lg:text-lg leading-relaxed max-w-3xl">
              Providing reliable kitchen infrastructure solutions that enhance
              productivity, durability, safety, and efficiency as a trusted
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          {industries.map((item, index) => (
            <FadeInSection key={index} delay={index * 0.15}>
              <div className="group relative overflow-hidden rounded-[24px] min-h-[300px] cursor-pointer transition-all duration-500 hover:-translate-y-2">
