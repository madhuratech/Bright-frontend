                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-6 lg:px-12">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-6 max-w-xl text-white text-sm sm:text-base md:text-lg leading-relaxed">
                            Make food preparation quicker and easier with reliable equipment designed to save time, improve efficiency, and deliver consistent results in every kitchen.
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    ...
                    <div className="mt-8 max-w-5xl">
                        <p className="text-[#555555] text-sm md:text-base leading-relaxed">
                            Every commercial kitchen depends on smooth and efficient food preparation. At Bright Industries,
                            we provide preparation equipment that helps reduce manual effort, speed up daily tasks, and maintain
                            food quality from start to finish. Whether you're preparing vegetables, meat, dough, or ingredients
                            for large-scale cooking, our equipment is built to handle demanding workloads with ease.
                            Designed for restaurants, hotels, cafés, bakeries, and catering businesses, our solutions help your
                            kitchen stay productive every day.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-12">
                        ...
                        <div className="text-center mb-14">
                            ...
                            <p className="mt-4 max-w-3xl mx-auto text-[#666666] leading-relaxed">
                                Dependable preparation equipment designed to simplify kitchen tasks, improve productivity, and support consistent food preparation every day.
                            </p>
                        </div>
